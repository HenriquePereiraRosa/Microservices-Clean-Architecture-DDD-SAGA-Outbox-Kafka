...
public class PaymentFailedKafkaMessagePublisher implements IPaymentFailedMessagePublisher {
    ...
    public PaymentFailedKafkaMessagePublisher(PaymentMessagingDataMapper mapper,
    ...
    public void publish(PaymentFailedEvent domainEvent) {
        ...
        try {
            PaymentResponseAvroModel avroModel = mapper.paymentFailedEventToPaymentResponseAvroModel(domainEvent);
