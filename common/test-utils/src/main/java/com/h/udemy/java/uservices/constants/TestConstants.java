...
public interface TestConstants {
    ...
    //    UUID CUSTOMER_ID = UUID.fromString("6c1cdc4d-2b8f-4582-b765-349931ddb653");
//    UUID ORDER_UUID = UUID.fromString("efcf7559-cb80-41fe-991e-1a60b68b0532");
//    UUID STREET_ADDRESS_UUID = UUID.fromString("9e672465-f656-48c0-8c96-d0ecc631f32c");
//    UUID RESTAURANT_UUID = UUID.fromString("e42502d3-6099-44ad-bcbe-e30f85ec9d9e");
